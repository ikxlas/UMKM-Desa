  ...
  <main class="min-h-screen bg-gray-50 pb-20 pt-10">
    <div class="max-w-7xl mx-auto px-6 md:px-12">
      ...
      <div class="mb-10 text-center max-w-2xl mx-auto">
        <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Daftar Toko UMKM Dewa</h1>
      ...
      <!-- Empty State -->
      <div v-else-if="merchants.length === 0" class="text-center py-20 bg-white rounded-2xl border border-gray-100">
         <div class="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-4">
           <Store class="w-8 h-8 text-gray-400" />
         </div>
         <h3 class="text-lg font-bold text-gray-900 mb-2">Belum Ada Toko Terdaftar</h3>
         <p class="text-gray-500 text-sm max-w-sm mx-auto">Saat ini belum ada data UMKM yang terdaftar di sistem. Silakan kembali lagi nanti.</p>
      </div>
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div class="px-5 pb-5 relative flex-1 flex flex-col">
             ...
             <div class="-mt-10 w-16 h-16 rounded-xl border-4 border-white overflow-hidden bg-white shadow-sm shrink-0 mb-3 z-10 relative">
                <img :src="m.logo || '/images/bumn.png'" class="w-full h-full object-cover" />
             </div>
             
             <!-- Content -->
             <h3 class="font-extrabold text-gray-900 text-lg line-clamp-1 mb-1">{{ m.name }}</h3>
             ...
             <p class="text-sm text-gray-600 line-clamp-2 mb-6 flex-1">
